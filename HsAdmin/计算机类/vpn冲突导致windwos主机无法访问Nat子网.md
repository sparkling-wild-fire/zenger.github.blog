...
1. 删除vpn服务写入的路由：`route delete 192.168.150.1`，当这条路由的ip前缀长度为32时，采用这种方法，否则尽量新增一条路由，以避免其他ip无法路由。
